public class MovePool {
    public static final Move KALMOT = new Move("Kalmot", 6, false, 1);
    public static final Move FLEE = new Move("Flee", 0, true, 1);
    ...
    public static final Move BITE = new Move("Bite", 3, false, 1, Effect.RABIES);
    public static final Move BITE_TUTA = new Move("Bite", 2, false, 1);
    public static final Move TAHOL = new Move("Tahol", 0, true, 0, Effect.MULTIPLY_DAMAGE);
    ...
    public static final Move BURROW = new Move("Burrow", 0, true, 1, Effect.DODGE_NEXT_MOVE);
    public static Move GANG_UP = new Move("Gang Up", 3, false, 0, Effect.REPEAT_MOVE);
    ...
    public static final Move DAPO = new Move("Dapo", 2, false, 1);
    public static final Move DAPO_FLYING = new Move("Dapo", 6, false, 1);
    public static final Move LIPAD = new Move("Lipad", 5, false, 1);
    public static final Move NGATNGAT = new Move("Ngatngat", 3, false, 1);
    public static final Move SQUEAK = new Move("Squeak", 0, false, 1);
    public static final Move DAPO_LAMOK = new Move("Dapo", 0, false, 1);
    public static final Move SUCK = new Move("Suck", 5, false, 1, Effect.DENGUE);
    public static final Move SIT_AND_WAIT = new Move("Sit-and-Wait", 0, false, 1);
    public static final Move LICK = new Move("Lick", 4, false, 1);
    public static final Move PECK = new Move("Peck", 4, false, 1);
    ...
    public static final Move FLEE_LANGAW = new Move("Flee", 0, true, 1);
    ...
    public static final Move SLITHER = new Move("Slither", 0, true, 1);
    public static final Move KAGAT_SNAKE = new Move("Kagat", 0, false, 1);
    public static final Move HISS = new Move("Hiss", 0, true, 1);
    public static final Move DAPO_HIGAD = new Move("Dapo", 0, true, 1);
    public static final Move KARATE_CHOP = new Move("Karate Chop", 0, false, 1);
    public static final Move TADYAK = new Move("Tadyak", 0, false, 1);
