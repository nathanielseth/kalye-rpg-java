...
public class PokeKalyeData {
    ...
    public static final PokeKalye PUSPIN = new PokeKalye("Puspin", 25, MovePool.KALMOT, MovePool.FLEE, MovePool.PURR);
    ...
    public static final PokeKalye ANTIK = new PokeKalye("Antik", 30, MovePool.KAGAT, MovePool.BURROW, MovePool.GANG_UP);
    ...
    public static final PokeKalye FLYING_IPIS = new PokeKalye("Flying Ipis", 40, MovePool.SCRATCH, MovePool.DAPO_FLYING,
            MovePool.LIPAD);
    public static final PokeKalye DAGA = new PokeKalye("Daga", 28, MovePool.NGATNGAT, MovePool.SQUEAK);
    public static final PokeKalye LAMOK = new PokeKalye("Lamok", 12, MovePool.DAPO_LAMOK, MovePool.SUCK);
    public static final PokeKalye BUTIKI = new PokeKalye("Butiki", 25, MovePool.LICK, MovePool.SIT_AND_WAIT);
    ...
    public static final PokeKalye MANOK = new PokeKalye("Manok", 20, MovePool.TIKTILAOK, MovePool.PECK, MovePool.LIPAD,
            MovePool.FLEE);
    public static final PokeKalye GAGAMBA = new PokeKalye("Gagamba", 12, MovePool.DAPO, MovePool.KAGAT);
