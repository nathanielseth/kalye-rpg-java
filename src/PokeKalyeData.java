...
public class PokeKalyeData {
        ...
        public static final PokeKalye PUSPIN = new PokeKalye("Puspin", 25, MovePool.KALMOT, MovePool.FLEE,
                        MovePool.PURR);
        public static final PokeKalye PUSPIN_BOOTS = new PokeKalye("Puspin Boots", 50, MovePool.KALMOT, MovePool.FLEE,
        ...
        public static final PokeKalye ANTIK = new PokeKalye("Antik", 20, MovePool.KAGAT, MovePool.BURROW,
                        MovePool.GANG_UP);
        public static final PokeKalye ANTMAN = new PokeKalye("Ant-Man", 60, MovePool.KAGAT, MovePool.BURROW,
                        MovePool.GANG_UP,
        ...
        public static final PokeKalye FLYING_IPIS = new PokeKalye("Flying\n Ipis", 40, MovePool.SCRATCH,
        ...
        public static final PokeKalye MANOK = new PokeKalye("Manok", 15, MovePool.TIKTILAOK, MovePool.PECK,
                        MovePool.LIPAD,
                        MovePool.FLEE);
        public static final PokeKalye GAGAMBA = new PokeKalye("Gagamba", 16, MovePool.DAPO, MovePool.KAGAT);
        ...
        public static final PokeKalye MASTER_SPLINTER = new PokeKalye("Master\n Splinter", 1000,
